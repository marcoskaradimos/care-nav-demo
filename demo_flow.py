...
NODES["doctor_symptom_form"] = form(
    ...
    [
        {"id": "symptom_description", "label": "What is the reason for calling today?", "type": "long_text", "required": True, "placeholder": "Please describe your symptoms..."},
        ...
        {"id": "symptom_character",   "label": "How would you describe it?", "type": "select", "required": False,
         "options": ["Select one", "Dull", "Sharp", "Stabbing", "Burning", "Aching", "Throbbing", "Other"]},
        {"id": "symptom_severity",    "label": "Are you experiencing pain?", "type": "pain_check", "required": False},
        {"id": "symptom_triggers",    "label": "What makes it better or worse?", "type": "long_text", "required": False, "placeholder": "e.g. worse when walking, better with rest..."},
